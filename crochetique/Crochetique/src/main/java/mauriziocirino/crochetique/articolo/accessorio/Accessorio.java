package mauriziocirino.crochetique.articolo.accessorio;
...
public class Accessorio extends Articolo {
    ...
    public Accessorio(int id, String dimensione, String descrizione, String foto, int numAcquisti, int sconto, int codiceTessuto, boolean indossabile) {
        super(id, dimensione, descrizione, foto, numAcquisti, sconto, codiceTessuto);
        this.indossabile = indossabile;
    }

    public Accessorio(int id, String dimensione, String descrizione, String foto, int numAcquisti, int sconto, int codiceTessuto, int idCatalogo, boolean indossabile) {
